    ...
    <>
      ...
      <div className="w-100 vh-100 d-flex justify-content-end align-items-center p-5">
        <div className="about text-end">
          <Typography variant="h1" style={{fontSize: window.outerWidth<700?"3vw" : '2vw'}}>About JPShopFit</Typography>
          <Typography variant="h5" style={{fontSize: window.outerWidth<700?"3vw" : '2vw'}}>
