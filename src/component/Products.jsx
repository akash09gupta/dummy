...
// useEffect(()=>{},[]) for further use to fetch products
  ...
  return (
    <div className="container mt-5 pt-5">
      ...
      <Typography variant={isMobile ? "h4" : "h3"} className="pb-4 ms-1 fw-normal d-flex align-items-center" >
        Our <span variant={isMobile ? "h4" : "h3"} className="mt-0 fw-normal"  style={{ color: "#105B63", padding: "0 0.5rem" }}>Products</span>
      </Typography>
